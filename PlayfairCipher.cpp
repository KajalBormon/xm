...
char BogusChar = 'x';
///ekta kaj kora hoy nai: i,j pair hole track rakhte hobe, seta i cilo naki j: decryption er result e lagbe.
...
string encrypt(string &Plaintext){
    string cipherText = "";
    char ch1, ch2;
    pair<int, int> p1, p2, r1, r2;///charToPoint = > (p1,p2) => (r1,r2) => char again
    for(int i = 0; i < Plaintext.size(); i += 2){
        ...
        ///cout<<"("<<r1.first<<", "<<r1.second<<"), ("<<r2.first<<", "<<r2.second<<")"<<endl<<endl;
...
string decrypt(string &cipherText){
    ...
    for(int i = 0; i < cipherText.size(); i += 2){
        ///cout<<cipherText[i]<<" "<<cipherText[i+1]<<endl;
